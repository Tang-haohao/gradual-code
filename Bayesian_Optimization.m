...
for num_vari = 30
    ...
    for run=1:time_run
        ...
        while evaluation < max_evaluation
            ...
            %model_new = Kriging_Incremental_Update(GP_model,sample_x,sample_y)
    ...
    t2 = clock;
    t=2 * etime(t2,t1);
    save(strcat('BO',fun_name,num2str(num_vari),'-',num2str(max_evaluation),'.mat'),'fmin_record');
    save(strcat('BO_time',fun_name,num2str(num_vari),'-',num2str(max_evaluation),'.mat'),'t');
end
